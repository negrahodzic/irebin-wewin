...
| **Digital Twin** | Bentley iTwin Viewer SDK | 3D visualization and spatial analytics |
| **Backend** | Supabase | Real-time database and authentication |
| **Deployment** | Vercel | Fast, reliable hosting and CI/CD |
| **Development** | Next.js 14 | Full-stack React framework |
...
1. **Clone the repository**
   \`\`\`bash
   git clone https://github.com/broogle/irebin-wewin.git
   cd irebin-wewin
   \`\`\`
...
### Citizen Account
- **Email**: `citizen@irebin.com`
- **Password**: `demo123`

### Admin Account  
- **Email**: `admin@nottingham.gov.uk`
- **Password**: `admin123`

---

## 🏘️ Nottingham Integration

### Featured Neighborhoods
- **Beeston Village** - Leading in recycling rates
- **West Bridgford** - Community engagement champions  
- **Mapperley Park** - Educational content leaders
- **Sherwood** - Consistency award winners
- **Gedling** - Route optimization pioneers

### Community Impact
- **47+ active neighborhoods** across Nottingham
- **12,847+ participating households**
- **89% average recycling rate** city-wide
- **2,340 tons CO₂** saved annually
...
---
## 🤝 Team
- **Rohit Ushir** - Nottingham Trent University 
- **Harmohan Singh Johal** - Nottingham Trent University 
- **Negra Hodzic** - Nottingham Trent University


## 🤝 Partners & Acknowledgments

### Technology Partners
- **Bentley Systems** - iTwin Platform integration
